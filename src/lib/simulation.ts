...
const REASONS: string[] = [
  'Simulation: carbon intensity is above threshold - routing to a lower-carbon region',
  'Simulation: renewable availability is high - opportunistic shift triggered',
  'Simulation: marginal emissions are elevated - deferring non-urgent batch job',
  'Simulation: water stress index is critical - throttling GPU cluster',
  'Simulation: carbon signal is stale - holding decision until the next synthetic refresh',
  'Simulation: load spike and high carbon - emergency throttle applied',
  'Simulation: a greener window opened - scheduling deferred jobs now',
  'Simulation: cross-region latency is acceptable - shifting to ca-central-1',
  'Simulation: peak demand forecast - pre-emptive defer to off-peak slot',
  'Simulation: trace reference generated for operator drill output',
]
