  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <svg viewBox="0 0 32 32" width="28" height="28" fill="none" aria-label="CO2 Grid">
        ...
        <div>
          <div className="text-sm font-bold tracking-wide" style={{ color: '#e2e8f0', letterSpacing: '0.06em' }}>
            CO2 GRID
          </div>
          <div className="text-[9px] font-mono tracking-widest" style={{ color: 'rgba(56,189,248,0.5)' }}>
            CO2 ROUTER CONTROL PLANE
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:flex items-center gap-6">
        {[
          ...
          <div key={k.label} className="text-center">
            ...
            <div className="text-sm font-bold font-mono tabular-nums" style={{ color: k.color }}>
              {k.value}
            </div>
          </div>
        ))}
        ...
        <div className="flex gap-0.5 bg-white/[0.03] rounded-xl p-0.5 mr-2">
          {[
            ...
            <button
              ...
              style={{
                background: viewMode === id ? 'rgba(45,212,191,0.16)' : 'transparent',
                color: viewMode === id ? '#2dd4bf' : '#64748b',
